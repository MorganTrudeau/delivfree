        ...
        return (
          <View
            ...
            style={[
              ...
              {
                top: a[1] || 0,
                left: isRTL ? undefined : a[0] || 0,
                right: isRTL ? a[0] || 0 : undefined,
              },
            ]}
          >
            <View style={styles.outerHourInner}>
              <Text
                style={isCurrent ? { color } : { color: colors.text }}
                selectable={false}
              >
...
const styles = StyleSheet.create({
  outerHourRoot: {
    ...
    width: 50,
    height: 50,
    marginLeft: isRTL ? undefined : -25,
    marginRight: isRTL ? -25 : undefined,
    marginTop: -25,
